...
class AppTheme {
  ...
  static Color customFocusColor = HexColor('#b453ff');
  ...
  static Color customButtonBgColor = HexColor('#b453ff');
  ...
  static List<Color> tutorialBgColor = [
    HexColor('#b24eff'),
    HexColor('#c37afc').withOpacity(0.8),
    HexColor('#d9abfc').withOpacity(0.6)
  ];
